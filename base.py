# https://data.mendeley.com/datasets/pwyyg8zmk5/2
...
while True:
    ...
    if ret:
        ...
        for class_name, count in class_counts.items():
            ...
            cv2.putText(frame, f'{class_name}: {count}', (100 + text_width, 100 + text_height), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
